...
public sealed class ErrorCode : DetailCode
{
    ...
    #region Sports-Specific Business Errors

    public static readonly ErrorCode MatchAlreadyStarted = new(DetailCodeRange.Error.Sports.Min, "MatchAlreadyStarted", "The match has already started.");
    public static readonly ErrorCode MatchNotActive = new(DetailCodeRange.Error.Sports.Min + 1, "MatchNotActive", "The match is not currently active.");
    public static readonly ErrorCode PlayerNotEligible = new(DetailCodeRange.Error.Sports.Min + 2, "PlayerNotEligible", "The player is not eligible for this operation.");
    public static readonly ErrorCode TeamNotFound = new(DetailCodeRange.Error.Sports.Min + 3, "TeamNotFound", "The specified team was not found.");
    public static readonly ErrorCode SeasonEnded = new(DetailCodeRange.Error.Sports.Min + 4, "SeasonEnded", "The season has already ended.");
    public static readonly ErrorCode InvalidScore = new(DetailCodeRange.Error.Sports.Min + 5, "InvalidScore", "The score is invalid for this sport.");
    public static readonly ErrorCode MaxPlayersReached = new(DetailCodeRange.Error.Sports.Min + 6, "MaxPlayersReached", "Maximum number of players reached.");
    public static readonly ErrorCode PlayerAlreadyInTeam = new(DetailCodeRange.Error.Sports.Min + 7, "PlayerAlreadyInTeam", "The player is already in a team.");
    public static readonly ErrorCode PlayerNotInTeam = new(DetailCodeRange.Error.Sports.Min + 8, "PlayerNotInTeam", "The player is not in the specified team.");
    public static readonly ErrorCode MatchNotFinished = new(DetailCodeRange.Error.Sports.Min + 9, "MatchNotFinished", "The match has not finished yet.");
    public static readonly ErrorCode InvalidMatchPeriod = new(DetailCodeRange.Error.Sports.Min + 10, "InvalidMatchPeriod", "Invalid match period for this sport.");
    public static readonly ErrorCode PlayerInjured = new(DetailCodeRange.Error.Sports.Min + 11, "PlayerInjured", "The player is injured and cannot participate.");
    public static readonly ErrorCode PlayerSuspended = new(DetailCodeRange.Error.Sports.Min + 12, "PlayerSuspended", "The player is suspended.");
    public static readonly ErrorCode TeamInactive = new(DetailCodeRange.Error.Sports.Min + 13, "TeamInactive", "The team is inactive.");
    public static readonly ErrorCode VenueUnavailable = new(DetailCodeRange.Error.Sports.Min + 14, "VenueUnavailable", "The venue is unavailable.");
    public static readonly ErrorCode WeatherCancellation = new(DetailCodeRange.Error.Sports.Min + 15, "WeatherCancellation", "The event was cancelled due to weather conditions.");
    public static readonly ErrorCode EquipmentFailure = new(DetailCodeRange.Error.Sports.Min + 16, "EquipmentFailure", "Equipment failure occurred.");
    public static readonly ErrorCode OfficialUnavailable = new(DetailCodeRange.Error.Sports.Min + 17, "OfficialUnavailable", "No official is available for the match.");
    public static readonly ErrorCode TournamentFull = new(DetailCodeRange.Error.Sports.Min + 18, "TournamentFull", "The tournament is full.");
    public static readonly ErrorCode RegistrationClosed = new(DetailCodeRange.Error.Sports.Min + 19, "RegistrationClosed", "Registration period has closed.");
    ...
    public static IEnumerable<ErrorCode> GetSportsErrors() => GetByRange(DetailCodeRange.Error.Sports.Min, DetailCodeRange.Error.Sports.Max);
