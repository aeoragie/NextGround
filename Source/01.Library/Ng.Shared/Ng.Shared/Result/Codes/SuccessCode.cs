...
public sealed class SuccessCode : DetailCode
{
    ...
    #region Sports Operations

    public static readonly SuccessCode MatchCreated = new(DetailCodeRange.Success.Sports.Min, "MatchCreated", "Match successfully created.");
    public static readonly SuccessCode MatchStarted = new(DetailCodeRange.Success.Sports.Min + 1, "MatchStarted", "Match successfully started.");
    public static readonly SuccessCode MatchEnded = new(DetailCodeRange.Success.Sports.Min + 2, "MatchEnded", "Match successfully ended.");
    public static readonly SuccessCode MatchPaused = new(DetailCodeRange.Success.Sports.Min + 3, "MatchPaused", "Match successfully paused.");
    public static readonly SuccessCode MatchResumed = new(DetailCodeRange.Success.Sports.Min + 4, "MatchResumed", "Match successfully resumed.");
    public static readonly SuccessCode MatchCancelled = new(DetailCodeRange.Success.Sports.Min + 5, "MatchCancelled", "Match successfully cancelled.");
    public static readonly SuccessCode ScoreUpdated = new(DetailCodeRange.Success.Sports.Min + 6, "ScoreUpdated", "Score successfully updated.");
    public static readonly SuccessCode ScoreSubmitted = new(DetailCodeRange.Success.Sports.Min + 7, "ScoreSubmitted", "Score successfully submitted.");
    public static readonly SuccessCode PlayerJoined = new(DetailCodeRange.Success.Sports.Min + 8, "PlayerJoined", "Player successfully joined the team.");
    public static readonly SuccessCode PlayerLeft = new(DetailCodeRange.Success.Sports.Min + 9, "PlayerLeft", "Player successfully left the team.");
    public static readonly SuccessCode PlayerSubstituted = new(DetailCodeRange.Success.Sports.Min + 10, "PlayerSubstituted", "Player successfully substituted.");
    public static readonly SuccessCode TeamCreated = new(DetailCodeRange.Success.Sports.Min + 11, "TeamCreated", "Team successfully created.");
    public static readonly SuccessCode TeamUpdated = new(DetailCodeRange.Success.Sports.Min + 12, "TeamUpdated", "Team successfully updated.");
    public static readonly SuccessCode SeasonCreated = new(DetailCodeRange.Success.Sports.Min + 13, "SeasonCreated", "Season successfully created.");
    public static readonly SuccessCode SeasonStarted = new(DetailCodeRange.Success.Sports.Min + 14, "SeasonStarted", "Season successfully started.");
    public static readonly SuccessCode SeasonEnded = new(DetailCodeRange.Success.Sports.Min + 15, "SeasonEnded", "Season successfully ended.");
    public static readonly SuccessCode TournamentCreated = new(DetailCodeRange.Success.Sports.Min + 16, "TournamentCreated", "Tournament successfully created.");
    public static readonly SuccessCode TournamentStarted = new(DetailCodeRange.Success.Sports.Min + 17, "TournamentStarted", "Tournament successfully started.");
    public static readonly SuccessCode TournamentEnded = new(DetailCodeRange.Success.Sports.Min + 18, "TournamentEnded", "Tournament successfully ended.");
    public static readonly SuccessCode LeagueCreated = new(DetailCodeRange.Success.Sports.Min + 19, "LeagueCreated", "League successfully created.");
    public static readonly SuccessCode StandingsUpdated = new(DetailCodeRange.Success.Sports.Min + 20, "StandingsUpdated", "League standings successfully updated.");
    ...
    public bool IsSportsOperation => DetailCodeRange.IsInRange(Value, DetailCodeRange.Success.Sports.Min, DetailCodeRange.Success.Sports.Max);
