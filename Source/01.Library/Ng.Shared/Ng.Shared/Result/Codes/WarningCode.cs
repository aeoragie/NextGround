...
public sealed class WarningCode : DetailCode
{
    ...
    #region Sports-Specific Warnings

    public static readonly WarningCode MatchDataIncomplete = new(DetailCodeRange.Warning.Sports.Min, "MatchDataIncomplete", "Match data is incomplete.");
    public static readonly WarningCode PlayerEligibilityIssue = new(DetailCodeRange.Warning.Sports.Min + 1, "PlayerEligibilityIssue", "Player eligibility issue detected.");
    public static readonly WarningCode ScoreDiscrepancy = new(DetailCodeRange.Warning.Sports.Min + 2, "ScoreDiscrepancy", "Score discrepancy detected.");
    public static readonly WarningCode MatchTimeAdjustment = new(DetailCodeRange.Warning.Sports.Min + 3, "MatchTimeAdjustment", "Match time was adjusted.");
    public static readonly WarningCode TeamRosterIncomplete = new(DetailCodeRange.Warning.Sports.Min + 4, "TeamRosterIncomplete", "Team roster is incomplete.");
    public static readonly WarningCode SeasonOverlap = new(DetailCodeRange.Warning.Sports.Min + 5, "SeasonOverlap", "Season dates overlap with another season.");
    public static readonly WarningCode StatisticsOutdated = new(DetailCodeRange.Warning.Sports.Min + 6, "StatisticsOutdated", "Player or team statistics may be outdated.");
    public static readonly WarningCode RuleViolationMinor = new(DetailCodeRange.Warning.Sports.Min + 7, "RuleViolationMinor", "Minor rule violation detected.");
    public static readonly WarningCode EquipmentIssue = new(DetailCodeRange.Warning.Sports.Min + 8, "EquipmentIssue", "Equipment issue reported.");
    public static readonly WarningCode WeatherCondition = new(DetailCodeRange.Warning.Sports.Min + 9, "WeatherCondition", "Adverse weather condition may affect play.");
    ...
    public bool IsSportsWarning => DetailCodeRange.IsInRange(Value, DetailCodeRange.Warning.Sports.Min, DetailCodeRange.Warning.Sports.Max);
