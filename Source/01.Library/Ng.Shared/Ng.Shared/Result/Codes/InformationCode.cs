...
public sealed class InformationCode : DetailCode
{
    ...
    #region Sports-Specific Operations

    public static readonly InformationCode MatchCreated = new(DetailCodeRange.Information.Sports.Min, "MatchCreated", "Match successfully created.");
    public static readonly InformationCode MatchStarted = new(DetailCodeRange.Information.Sports.Min + 1, "MatchStarted", "Match has started.");
    public static readonly InformationCode MatchEnded = new(DetailCodeRange.Information.Sports.Min + 2, "MatchEnded", "Match has ended.");
    public static readonly InformationCode MatchPaused = new(DetailCodeRange.Information.Sports.Min + 3, "MatchPaused", "Match has been paused.");
    public static readonly InformationCode MatchResumed = new(DetailCodeRange.Information.Sports.Min + 4, "MatchResumed", "Match has been resumed.");
    public static readonly InformationCode ScoreUpdated = new(DetailCodeRange.Information.Sports.Min + 5, "ScoreUpdated", "Score successfully updated.");
    public static readonly InformationCode PlayerJoined = new(DetailCodeRange.Information.Sports.Min + 6, "PlayerJoined", "Player successfully joined the team.");
    public static readonly InformationCode PlayerLeft = new(DetailCodeRange.Information.Sports.Min + 7, "PlayerLeft", "Player has left the team.");
    public static readonly InformationCode TeamCreated = new(DetailCodeRange.Information.Sports.Min + 8, "TeamCreated", "Team successfully created.");
    public static readonly InformationCode SeasonStarted = new(DetailCodeRange.Information.Sports.Min + 9, "SeasonStarted", "Season has started.");
    public static readonly InformationCode SeasonEnded = new(DetailCodeRange.Information.Sports.Min + 10, "SeasonEnded", "Season has ended.");
    public static readonly InformationCode TournamentCreated = new(DetailCodeRange.Information.Sports.Min + 11, "TournamentCreated", "Tournament successfully created.");
    ...
    public bool IsSportsOperation => DetailCodeRange.IsInRange(Value, DetailCodeRange.Information.Sports.Min, DetailCodeRange.Information.Sports.Max);
